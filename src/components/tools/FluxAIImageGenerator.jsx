...
const FluxAIImageGenerator = ({ onClose, isMobile }) => {
  ...
  return (
    <div className={`fixed inset-0 bg-gray-800 z-50 flex flex-col ${isMobile ? 'p-4' : 'md:inset-y-4 md:inset-x-1/2 md:w-[900px] md:-ml-[450px] md:rounded-lg'} overflow-hidden`}>
