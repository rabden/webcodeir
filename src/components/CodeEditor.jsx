...
const CodeEditor = () => {
  ...
  const [assets, setAssets] = useState([
    ...
    { name: 'Material Icons', type: 'link', url: 'https://fonts.googleapis.com/icon?family=Material+Icons', enabled: false },
    { name: 'Alpine.js', type: 'script', url: 'https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js', enabled: false },
