...
export const topIcons = {
  ...
  Droplet, Eye, Facebook, FileMinus, FilePlus, FileText, Film, Gift, GitBranch,
  Inbox, Info, Instagram, Layers, Layout, LifeBuoy, MapPin, Maximize, Minimize,
  Monitor, Moon, Mouse, Package, Paperclip, PieChart, Pocket, Power, Radio,
  RefreshCw, Save, Server, ShoppingBag, ShoppingCart, Sidebar, Slash, Sliders,
  Smartphone, Speaker, StopCircle, Sun, Sunrise, Sunset, Tablet, Tag, Target,
